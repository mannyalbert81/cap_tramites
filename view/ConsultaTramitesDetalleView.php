...
<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form  action="<?php echo $helper->url("ConsultaTramitesDetalle","ConsultaTurnoTramitesDetalle"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
    						...
    						<?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
            	        		<tr>
            		               ...
            		               <td > <?php echo $res->nombres_empleados; ?>  </td>
            		           	     ...
            		           	     <td>   
            			                	<div class="right">
            			                    <a href="<?php echo $helper->url("ConsultaTramitesDetalle","ConsultaTurnoTramitesDetalle"); ?>&id_turnos_tramites=<?php echo $res->id_turnos_tramites; ?>" class="btn btn-info" style="font-size:65%;"><i class="glyphicon glyphicon-tags"></i></a>
            			                </div>
            			                <hr/>
            		               </td>
            		    		</tr>
